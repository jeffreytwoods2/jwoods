...
import logoDash from '@/images/logos/dash.png'
import logoUVSim from '@/images/logos/uvsim.svg'
import logoAiva from '@/images/logos/uvu.png'
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Jeffrey Woods</title>
        <meta
          name="description"
          content="Things I've made, for work and for play."
        />
      </Head>
      <SimpleLayout
        title="Things I've made, for work and for play."
        intro="I'm always working on something; here's a curated list of projects that have either been the most fun to build or the most impressive (IMO)."
      >
        <ul
          role="list"
